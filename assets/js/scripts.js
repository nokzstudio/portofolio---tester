...
$(function () {
    ...
    $(function () {
        ...
        function toggleLocalStorageItem() {
            if (isLight()) {
                ...
                $(".navbar .logo img , footer .logo img").attr("src", "conf/imgs/logo-light.svg");
            } else {
                localStorage.setItem("light-mode", "set");
                $(".navbar .logo img , footer .logo img").attr("src", "conf/imgs/logo-dark.svg");
            }
        }
        ...
        $("body.light .navbar .logo img , body.light footer .logo img").attr("src", "conf/imgs/logo-dark.svg");
    ...
    wind.on("scroll", function () {
        ...
        if (bodyScroll > 300) {
            ...
            logo.attr('src', 'conf/imgs/logo-dark.png');

        } else {

            navbar.removeClass("nav-scroll");
            logo.attr('src', 'conf/imgs/logo-light.png');
        }
    });
